    ...
    extend: {
      ...
      keyframes: {
        ...
        "shake-left": {
          ...
          "60%": { transform: "translateY(-12px) rotate(-15deg)" },
          "80%": { transform: "translateY(0) rotate(0deg)" },
        },
        "shake-right": {
          "0%, 100%": { transform: "translateY(0) rotate(0deg) scaleX(-1)" },
          "20%": { transform: "translateY(-12px) rotate(15deg) scaleX(-1)" },
          "40%": { transform: "translateY(0) rotate(0deg) scaleX(-1)" },
          "60%": { transform: "translateY(-12px) rotate(15deg) scaleX(-1)" },
      ...
      animation: {
        ...
        "shake-left": "shake-left 0.9s ease-in-out",
        "shake-right": "shake-right 0.9s ease-in-out",
